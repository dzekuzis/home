...
const Header = () => (
  ...
  <Link className="nav-link bmwImage" to="/home"><img src='https://www.bmw-motorsport.com/etc.clientlibs/ds2-webcomponents/clientlibs/clientlib/resources/img/BMW_White_Logo.svg' alt='' width='70' height='40' margin='0px' padding='0px'></img></Link>
